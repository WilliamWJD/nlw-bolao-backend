...
import { GetAllPoolsController } from '../controllers/GetAllPoolsController';
...
const getAllPoolsController = new GetAllPoolsController();
...
PoolRoutes.get('/', getAllPoolsController.handle);
